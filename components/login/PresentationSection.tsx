    ...
    <section className='mt-32 lg:mt-0 relative z-[0] mx-auto w-[90%] lg:w-[40rem] flex flex-col col-span-1'>
      ...
      <Link href='/explorar'>
        <a className='m-auto mt-5 xs:mt-14 lg:mt-20'>
          <button className='p-1 lg:p-2 px-2 rounded-md shadow-md text-green-dark hover:opacity-80 bg-green-extraLight font-thin tracking-widest text-sm xs:text-base md:text-xl '>
            EXPLORAR
          </button>
        </a>
      </Link>
