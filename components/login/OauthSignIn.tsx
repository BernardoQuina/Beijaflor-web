...
export const OauthSignIn: React.FC<OauthSignInProps> = ({}) => {
  ...
  return (
    <motion.div layoutId='oauth' className='mt-8'>
      <button
        className='flex py-2 px-4 mx-auto max-w-max rounded-md border-0 shadow-md group hover:bg-blue-300 focus:animate-bounce focus:outline-none'
        type='button'
        onClick={googleLogin}
      >
