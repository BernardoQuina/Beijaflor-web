  ...
  return (
    <section className='max-w-6xl 3xl:max-w-7xl mt-36 lg:mt-52 mx-auto'>
      <div className='w-[100%] md:w-[60%] flex flex-col'>
        ...
        <button className='mx-auto mt-14 md:mt-20 p-2 px-2 rounded-md shadow-md text-pink-dark opacity-95 bg-opacity-60 hover:opacity-100 hover:bg-opacity-100 bg-pink-light tracking-widest text-xl md:text-2xl '>
          EXPLORAR
        </button>
      </div>
