  ...
  return (
    <section className='relative flex mt-40 mx-auto max-w-[100rem]'>
      <div className='mx-auto w-full'>
        ...
        <button className=' self-end ml-auto mr-4 md:mr-20 xl:mr-8 h-10 p-1 px-2 rounded-md shadow-md text-white opacity-95 bg-opacity-60 hover:opacity-100 hover:bg-opacity-100 bg-pink-dark tracking-widest md:text-lg'>
          VER MAIS
        </button>
        </div>
