...
export const Support: React.FC<SupportProps> = ({ tailwind, strokeWidth }) => {
  return (
    <svg
    ...
    >
      ...
      />
      <circle strokeWidth={strokeWidth} cx='9' cy='13' r='1' />
      <circle strokeWidth={strokeWidth} cx='15' cy='13' r='1' />
      <path
        strokeWidth={strokeWidth}
