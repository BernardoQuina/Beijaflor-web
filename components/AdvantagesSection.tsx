    ...
    <section className='max-w-full 4xl:max-w-[120rem] mx-auto flex mt-12 2xl:mt-40'>
      <div className='lg:flex mx-auto md:w-[50%]'>
        <div className='mx-auto mt-20 text-center'>
          <Plant
            tailwind='h-12 md:h-16 mx-auto fill-current text-green-medium'
            strokeWidth={0.2}
          />
          <h6 className='tracking-widest md:text-xl font-bold'>
            Frescura garantida
          </h6>
          <p className='hidden md:inline-block w-56 mx-auto tracking-wider'>
        ...
        <div className='mx-auto mt-8 lg:mt-20 text-center'>
          <Shipping
            ...
            strokeWidth={0.1}
          />
          <h6 className='tracking-widest md:text-xl font-bold'>Envio grátis</h6>
          <p className='hidden md:inline-block w-56 mx-auto tracking-wider'>
      ...
      <div className='lg:flex mx-auto md:w-[50%]'>
        <div className='mx-auto mt-20 text-center'>
          <Support
            tailwind='h-12 md:h-16 fill-current mx-auto text-green-medium'
            strokeWidth={0.2}
          />
          <h6 className='tracking-widest md:text-xl font-bold'>
            Suporte ao cliente
        ...
        <div className='mx-auto mt-8 lg:mt-20 text-center'>
          <Secure
            ...
            strokeWidth={0.2}
          />
          <h6 className='tracking-widest md:text-xl font-bold'>Compra Segura</h6>
          <p className='hidden md:inline-block w-56 mx-auto tracking-wider'>
