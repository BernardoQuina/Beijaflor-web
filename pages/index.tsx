  ...
  return (
    <Layout>
      <section className='max-w-6xl 3xl:max-w-7xl mt-36 lg:mt-52 mx-auto'>
        ...
        <h4 className='w-[55%] md:w-[45%] mt-32 md:mt-44 ml-20 md:ml-20 text-2xl tracking-wider leading-relaxed md:text-3xl text-center'>
      ...
      <section className='max-w-full 4xl:max-w-[120rem] mx-auto md:flex mt-20 md:mt-40'>
        <div className='lg:flex mx-auto md:w-[50%]'>
          <div className='mx-auto mt-20 text-center'>
            <Plant
              ...
              strokeWidth={0.2}
            />
            <h6 className='tracking-widest font-bold'>Frescura garantida</h6>
          ...
          <div className='mx-auto mt-20 text-center'>
            <Shipping
              ...
              strokeWidth={0.1}
            />
            <h6 className='tracking-widest font-bold'>Envio grátis</h6>
            <p className='w-56 mx-auto'>
        ...
        <div className='mx-auto mt-20 text-center'>
          <Support
            ...
            strokeWidth={0.2}
          />
          <h6 className='tracking-widest font-bold'>Suporte ao cliente</h6>
          <p className='w-56 mx-auto'>
        ...
        <div className='mx-auto mt-20 text-center'>
          <Secure
            ...
            strokeWidth={0.2}
          />
          <h6 className='tracking-widest font-bold'>Compra Segura</h6>
          <p className='w-56 mx-auto'>Métodos de pagamentos de confiança</p>
        </div>
        </div>
      </section>
    </Layout>
